...
import { File, Download, Eye, LoaderCircle } from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-300">Loading previous year questions...</p>
          </div>
        ) : files.length > 0 ? (
          ...
          <div className="text-center py-8">
            <p className="text-gray-300">No previous year questions found.</p>
          </div>
        )}
      </div>
    </div>
